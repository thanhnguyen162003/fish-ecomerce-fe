...
const SliderSix = () => {
    return (
        <>
            <div className="slider-block style-one bg-[#9fc5e8] xl:h-[860px] lg:h-[800px] md:h-[580px] sm:h-[500px] h-[350px] max-[420px]:h-[320px] w-full">
                            ...
                            <div className="slider-item h-full w-full relative overflow-hidden">
                                <div className="container w-full h-full flex items-center relative">
                                    <div className="text-content basis-1/2">
                                        ...
                                        <Link href='/shop/breadcrumb-img' className="button-main md:mt-8 mt-3">Khám phá ngay</Link>
                                    </div>
