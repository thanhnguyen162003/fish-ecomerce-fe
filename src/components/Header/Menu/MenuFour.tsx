                    ...
                    <div className="header-main flex items-center justify-between h-full">
                        ...
                        <div className="menu-main h-full xl:w-full flex items-center justify-center max-lg:hidden xl:absolute xl:top-1/2 xl:left-1/2 xl:-translate-x-1/2 xl:-translate-y-1/2">
                            <ul className='flex items-center gap-8 h-full'>
                                ...
                                <li className='h-full'>
                                    <Link href="/shop/breadcrumb-img" className='text-button-uppercase duration-300 h-full flex items-center justify-center'>
                                        Shop
                                    </Link>
                    ...
                    <div className="container h-full">
                        <div className="menu-main h-full overflow-hidden">
                            <div className="heading py-2 relative flex items-center justify-center">
                                ...
                                <Link href={'/'} className='logo text-3xl font-semibold text-center'>Aquamarine</Link>
                            </div>
