                                        ...
                                        <div className="container">
                                            <div className="flex justify-between py-8">
                                                <div className="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                    ...
                                                    <div className="nav-item">
                                                        <div className="text-button-uppercase pb-2">Newborn</div>
                                                        <ul>
                                                            <li>
                                                                <div
                                                                    onClick={() => handleTypeClick('clothing')}
                                                    ...
                                                    <div className="nav-item">
                                                        <div className="text-button-uppercase pb-2">Infant</div>
                                                        <ul>
                                                            <li>
                                                                <div
                                                                    onClick={() => handleTypeClick('bib')}
                                                                    className={`link text-secondary duration-300 cursor-pointer`}
                                                                >
                                                                    Chain bib
                                                                </div>
                                                    ...
                                                    <div className="nav-item">
                                                        <div className="text-button-uppercase pb-2">Kids</div>
                                                        <ul>
                                                            <li>
                                                                <div
                                                                    onClick={() => handleTypeClick('toy')}
                                                ...
                                                <div className="banner-ads-block pl-2.5 basis-1/3">
                                                    <div className="banner-ads-item bg-linear rounded-2xl relative overflow-hidden cursor-pointer" onClick={() => handleCategoryClick('toys-kid')}>
                                        ...
                                        <div className="sub-nav-mobile">
                                            ...
                                            <div className="list-nav-item w-full pt-3 pb-12">
                                                <div className="nav-link grid grid-cols-2 gap-5 gap-y-6">
                                                    ...
                                                    <div className="nav-item">
                                                        <div className="text-button-uppercase pb-1">Newborn</div>
                                                        <ul>
                                                            <li>
                                                                <div
                                                                    onClick={() => handleTypeClick('clothing')}
                                                    ...
                                                    <div className="nav-item">
                                                        <div className="text-button-uppercase pb-1">Infant</div>
                                                        <ul>
                                                            <li>
                                                                <div
                                                                    onClick={() => handleTypeClick('bib')}
                                                    ...
                                                    <div className="nav-item">
                                                        <div className="text-button-uppercase pb-1">Kids</div>
                                                        <ul>
                                                            <li>
                                                                <div
                                                                    onClick={() => handleTypeClick('toy')}
                                                ...
                                                <div className="banner-ads-block grid sm:grid-cols-2 items-center gap-6 pt-6">
                                                    <div className="banner-ads-item bg-linear rounded-2xl relative overflow-hidden" onClick={() => handleCategoryClick('toys-kid')}>
                                                        <div className="text-content py-14 pl-8 relative z-[1]">
                                                            <div className="text-button-uppercase text-white bg-red px-2 py-0.5 inline-block rounded-sm">Save $10</div>
