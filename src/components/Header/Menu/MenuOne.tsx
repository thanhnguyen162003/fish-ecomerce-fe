...
const MenuOne: React.FC<Props> = ({ background, text }) => {
  ...
  return (
    <div
      className={`header-menu item-center style-one ${
        fixedHeader ? "fixed" : "absolute"
      } top-0 left-0 right-0 w-full md:h-[74px] h-[56px]  ${background} ${text}`}
    >
                ...
                >
                  {jwt === null && (
                    <div>
                      <Link
                        href={"/login"}
                        className={`button-main w-full text-center ${background} ${text}`}
                      >
                        Login
                      </Link>
                      <div className="text-secondary text-center mt-3 pb-4">
                        ...
                        <Link
                          href={"/register"}
                          className={`text-black pl-1 hover:underline ${text}`}
                        >
                          Register
                        </Link>
                      </div>
                  ...
                  {jwt !== null && (
                    <div>
                      ...
                      <button
                        className={`button-main w-full text-center ${background} ${text} mt-3`}
